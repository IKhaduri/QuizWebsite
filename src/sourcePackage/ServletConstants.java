...
public class ServletConstants {
	public static final String QUIZ_PARAMETER_NAME = "quizName";
	public static final String USER_PARAMETER_NAME = "userName";
	...
	public static final int ACTIVITY_LISTS_LIMIT = 3;

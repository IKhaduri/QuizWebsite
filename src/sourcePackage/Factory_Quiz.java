...
public class Factory_Quiz {
	...
	private static int getTotalScore(List<QuestionAbstract> questions){
		int total = 0;
	 ...
	 * @return Quiz object
	 */
	public static Quiz getNewQuiz(String name, String author, String description, boolean shouldShuffle, int timeLimit, boolean isSinglePage, List<QuestionAbstract> questions){
		Quiz.Header header = new Quiz.Header(name, author, description);
	 ...
	 * @return Quiz object
	 */
	public static Quiz getQuiz(QuizBase base, boolean shouldShuffle, int questionCap, int timeLimit, boolean isSinglePage, List<QuestionAbstract> questions){
